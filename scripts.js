...
const events = [
  {
    ...
    summary: 'The flagship 2-day department fest by IETE Student Chapter featuring competitions and technical events on Oct 22-23, 2025.',
    ...
    details: `
      <div class="event-details">
        ...
        <ul>
          <li>Think-a-Bit (Tech Quiz) - Oct 22 & 23</li>
          <li>Gaming Tournament - Oct 22</li>
  ...
  },
  {
    ...
    registrationLink: 'https://forms.gle/bDL2G9pgLazvzaby6',
    details: `
      <div class="event-details">
        ...
        <div style="margin: 20px 0;">
          <a href="https://forms.gle/bDL2G9pgLazvzaby6" target="_blank" class="btn btn-primary" style="display: inline-block; padding: 12px 24px; background: var(--accent); color: white; text-decoration: none; border-radius: 8px; font-weight: 600;">📝 Submit Your Meme</a>
        </div>
  ...
  },
  {
    ...
    summary: 'Competitive gaming tournament featuring popular games. Show off your gaming skills and compete for prizes!',
    ...
    details: `
      <div class="event-details">
        ...
        <div style="margin: 20px 0;">
          <a href="https://docs.google.com/forms/d/e/1FAIpQLSdThip42vOSHo1yySlpxvlbAX3v1g_Ie87qSpkZPxXMRsTKNA/viewform?usp=dialog" target="_blank" class="btn btn-primary" style="display: inline-block; padding: 12px 24px; background: var(--accent); color: white; text-decoration: none; border-radius: 8px; font-weight: 600;">📝 Register for Gaming</a>
        </div>
