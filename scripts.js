...
const events = [
  {
    ...
    summary: 'The flagship 2-day department fest by IETE Student Chapter featuring gaming, quiz competitions, treasure hunt, and meme contest from Oct 22-23, 2025.',
    ...
    details: `
      <div class="event-details">
        ...
        <ul>
          ...
          <li><strong>Day 2 (Oct 23):</strong> Treasure Hunt & Gaming</li>
        </ul>
        
        <h4>🌟 Major Events Under ELECTROVERSE:</h4>
        <ul>
          <li>Think-a-Bit (Tech Quiz) - Oct 22-23</li>
          <li>Gaming Tournament - Oct 22-23</li>
  ...
  },
  {
    ...
    details: `
      <div class="event-details">
        ...
        <p><strong>Date:</strong> October 22-23, 2025</p>
        ...
        <ul>
          ...
          <li><strong>Time:</strong> 20 minutes per paper</li>
        </ul>
  ...
  },
  {
    ...
    summary: 'Creative online meme competition focusing on core domain topics.',
    ...
    details: `
      <div class="event-details">
        ...
        <ul>
          ...
          <li><strong>Theme:</strong> ECE/Technology</li>
  ...
  },
  {
    ...
    label: 'competition',
    title: 'Treasure Hunt',
    summary: 'Exciting campus-wide treasure hunt adventure.',
    ...
    details: `
      <div class="event-details">
        ...
        <p>Navigate through exciting clues and challenges across the campus!</p>
        ...
        <p><strong>🏆 Prizes:</strong> Exciting rewards for winners</p>
      </div>
    `
  },
  {
    ...
    summary: 'Competitive gaming tournament featuring popular games across both days.',
    ...
    details: `
      <div class="event-details">
        ...
        <p><strong>Date:</strong> October 22-23, 2025</p>
        <p><strong>Duration:</strong> Both days of the fest</p>
